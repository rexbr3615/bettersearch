...
public final class BetterSearchConfigScreen extends OptionRowsScreen {
    ...
    private static Component typoToleranceLabel(int value) {
        return switch (value) {
            case 0 -> ComponentCompat.translatable("bettersearch.config.value.off");
            case 1 -> ComponentCompat.translatable("bettersearch.config.value.low");
            case 2 -> ComponentCompat.translatable("bettersearch.config.value.normal");
            default -> ComponentCompat.translatable("bettersearch.config.value.high");
        };
    }
    ...
    private static Component effortLabel(int level) {
        return ComponentCompat.translatable(switch (level) {

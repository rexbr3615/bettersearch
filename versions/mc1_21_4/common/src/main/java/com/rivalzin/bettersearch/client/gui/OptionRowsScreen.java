...
public abstract class OptionRowsScreen extends Screen {
    ...
    private int renderPreview(GuiGraphics guiGraphics, ResourceLocation texture) {
        ...
        /*
         * 1.21.2 em diante: o blit pede quem escolhe o RenderType da textura - e o
         * RenderType::guiTextured ja desenha com a mistura ligada, entao os
         * RenderSystem.enableBlend/defaultBlendFunc/disableBlend da 1.21.1 sairam daqui:
         * com o desenho passando pelo buffer do RenderType, mexer no estado global nem
         * teria efeito. Assinatura conferida com javap no neoforge-21.4.157-merged:
         * (fn, textura, x, y, u, v, largura, altura, uLarg, vAlt, texLarg, texAlt).
         */
        guiGraphics.blit(RenderType::guiTextured, texture, imageX, imageY,

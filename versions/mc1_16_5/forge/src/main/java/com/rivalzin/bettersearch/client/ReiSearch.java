...
public final class ReiSearch {
    ...
    private static final class BetterSearchFilter implements SearchFilter {
        ...
        /*
         * NAO existe test(EntryStack, long) nesta linha do REI.
         *
         * Da 1.18.2 em diante o SearchFilter ganhou uma sobrecarga que recebe o hash da
         * entrada ja calculado. Na 6.5 ele e apenas Predicate<EntryStack<?>> - conferido com
         * javap. Deixar o @Override aqui nem compila; deixar o metodo sem @Override compilaria
         * e nunca seria chamado, que e pior.
         */
        @Override
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof BetterSearchFilter) {
                return original.equals(((BetterSearchFilter) other).original);
            }
    ...
    private static SearchIndex<EntryStack<?>> ensureIndex(SearchSettings settings) {
        ...
        /*
         * NAO use getStage() aqui. Esta e a armadilha desta versao.
         *
         * Do REI 8 em diante existe isReloading(), que responde de verdade. Na 6.5 nao existe, e
         * eu traduzi para getStage() != END do Reloadable - a assinatura casava, o compilador
         * aceitou, e a secao 19 aprovou porque o metodo existe mesmo. Mas o corpo do
         * EntryRegistryImpl da 6.5 e uma constante:
         *
         *     public ReloadStage getStage();
         *        0: getstatic  // Field ReloadStage.START
         *        3: areturn
         *
         * Ou seja, "!= END" era SEMPRE verdadeiro: o indice nunca era montado e a busca do REI
         * simplesmente nao acontecia - sem crash e sem uma linha no log.
         *
         * A prontidao ja estava sendo medida logo abaixo, e da maneira certa: enquanto o REI nao
         * terminou de carregar, o getPreFilteredList vem vazio. E quando ele cresce, o INDEX
         * reconstroi sozinho porque a chave do cache inclui o tamanho da lista.
         *
         * Licao: assinatura existir nao e o mesmo que o metodo significar o que se espera. A
         * secao 19 passou a desmontar o corpo deste metodo por causa disto.
         */

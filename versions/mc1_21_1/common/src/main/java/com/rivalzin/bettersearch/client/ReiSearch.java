...
public final class ReiSearch {
    ...
    /** O gerente de busca do REI visto por ultimo (chega pelo mixin do EntryListSearchManager). */
    private static java.lang.ref.WeakReference<AsyncSearchManager> managerRef =
            new java.lang.ref.WeakReference<>(null);

    static {
        // REI: o AsyncSearchManager guarda o resultado do texto atual; markDirty faz a
        // lista recomputar no proximo quadro com os gates novos (javap: public markDirty()).
    ...
    /** Chamado pelo mixin a cada ordenacao - guarda quem cutucar quando a config mudar. */

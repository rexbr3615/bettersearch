...
public abstract class OptionRowsScreen extends Screen {
    ...
    protected static final class Row {
        ...
        Identifier preview;         // pode ser nulo
        int y;
    ...
    // 1.21.9 em diante o clique virou um objeto; o miolo do arrasto continua o mesmo.
    @Override
     ...
     */
    private int renderPreview(GuiGraphics guiGraphics, Identifier texture) {

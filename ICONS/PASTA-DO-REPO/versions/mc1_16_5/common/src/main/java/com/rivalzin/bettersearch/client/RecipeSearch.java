...
public final class RecipeSearch {
    ...
    private static SearchIndex<RecipeCollection> ensureIndex() {
        ...
        final List<RecipeCollection> snapshot = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(collections));
    ...
    private static SearchIndex<RecipeCollection> build(List<RecipeCollection> collections,
        ...
        for (RecipeCollection collection : collections) {
            try {
                ...
                // 1.20.1: as receitas vem cruas, sem o embrulho RecipeHolder que chegou na 1.21.
                for (Recipe<?> recipe : collection.getRecipes()) {
                    // 1.19.2: getResultItem() ainda nao pede RegistryAccess. O parametro so
                    // apareceu na 1.20.1, quando a receita passou a resolver o resultado
                    // contra o registro do mundo.
